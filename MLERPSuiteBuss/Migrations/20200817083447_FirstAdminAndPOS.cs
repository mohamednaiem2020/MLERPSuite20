        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    PackageId = table.Column<int>(nullable: false),
                    ModuleId = table.Column<int>(nullable: false),
                    AdminModuleModuleId = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_AdminPackageModule", x => new { x.PackageId, x.ModuleId });
                    table.ForeignKey(
                        name: "FK_AdminPackageModule_AdminModule_AdminModuleModuleId",
                        column: x => x.AdminModuleModuleId,
                        principalTable: "AdminModule",
                        principalColumn: "ModuleId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AdminPackageModule_AdminPackage_ModuleId",
                        column: x => x.ModuleId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AdminScreen_AdminModule_ModuleId",
                        column: x => x.ModuleId,
                        principalTable: "AdminModule",
                        principalColumn: "ModuleId",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsProcessInventory = table.Column<byte>(nullable: false),
                    IsProcessAccounting = table.Column<byte>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FirstClassName = table.Column<string>(nullable: false),
                    FirstFunctionName = table.Column<string>(nullable: false),
                    SecondClassName = table.Column<string>(nullable: false),
                    SecondFunctionName = table.Column<string>(nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AdminPackageModule_AdminModuleModuleId",
